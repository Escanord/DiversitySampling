...
int main(int argc, char **argv)
{
    ...
    if (sample_size <= 0)
    {
        std::cerr << "Invalid value for parameter <sample_size>" << std::endl;
        return -1;
    }
    if (race_range <= 0)
    {
        std::cerr << "Invalid value for optional parameter --range" << std::endl;
        return -1;
    }
    // R
    if (race_repetitions <= 0)
    {
    ...
    if (kmer_k <= 0)
    {
        std::cerr << "Invalid value for optional parameter --k" << std::endl;
        return -1;
    }
